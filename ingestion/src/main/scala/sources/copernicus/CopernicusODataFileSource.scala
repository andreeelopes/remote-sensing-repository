...
//  extends Source("copernicus.copernicus-oah-odata", config) with AuthComponent {
//  override val authConfigOpt = Some(AuthConfig("copernicus.copernicus-oah-odata", config)) //TODO não pode estar sempre a ir ao disco
...
//                    new FetchAndSaveSource("copernicus.copernicus-oah-odata", source.config), //TODO add own conf
