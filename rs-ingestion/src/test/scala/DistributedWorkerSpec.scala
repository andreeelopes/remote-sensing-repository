...
//
//    def receive = {
//      case WorkExecutor.DoWork(work: Work) =>
//        i += 1
//        if (i == 3) {
...
//    def receive = {
//      case WorkExecutor.DoWork(job: Job) =>
//        val n2 = job.i * job.i
//        val result = s"${job.i} * ${job.i} = $n2"
//        sender() ! WorkExecutor.WorkComplete(result)
//    }
//  }
//
//  class RemoteControllableFrontend extends Orchestrator {
//
...
//    for (n <- 2 to 100) {
//      frontend ! Work(n.toString, Job(n))
//      expectMsg(s"ok-$n")
//    }
